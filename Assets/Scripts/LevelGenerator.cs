...
public class LevelGenerator : MonoBehaviour
{
    ...
    public Transform CyllinderRoot;
    public float ExtraCyllinderScale = 1f;
    public Game Game;
    ...
    private void Awake()
    {
        ...
        CyllinderRoot.localScale = new Vector3(1, platformsCount * DistanceBetweenPlatforms, 1);
    }
    ...
    {
        return new Vector3(0, -DistanceBetweenPlatforms * platformIndex + ExtraCyllinderScale, 0);
    }
}
